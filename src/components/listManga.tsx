    ...
    return (
        <>
            ...
            <div className="list_container mx-auto mt-1 ml-1 gap-3">
                ...
                <div className="list_item">
                    <Link href={"truyen/hiep-sy-cong-chua-la-nang-dau-toc-man-di-9983"} className="cursor-pointer">
                        <Image src={"/images/manga/hiep-sy-cong-chua-la-nang-dau-toc-man-di-9983.jpg"} alt={"#"}
                               className="image"
                               width={170}
                               height={180}
                        />
                ...
                <div className="list_item">
                    <Link href={"/truyen/isekai-death-game-ni-tensou-sarete-tsura-5655"} className="cursor-pointer">
                        <Image src={"/images/manga/isekai-death-game-ni-tensou-sarete-tsura-5655.jpg"} alt={"#"}
                               className="image"
                               width={170}
                               height={180}
                        />
                ...
                <div className="list_item">
                    <Link href={"/truyen/ke-ca-ban-sao-cung-biet-yeu"} className="cursor-pointer">
                ...
                <div className="list_item">
                    <Link href={"/truyen/loi-nguyen-van-chua-cham-dut"} className="cursor-pointer">
                ...
                <div className="list_item">
                    <Link href={"/truyen/long-lay-phut-lia-doi"} className="cursor-pointer">
                ...
                <div className="list_item">
                    <Link href={"/truyen/shishidou-san-ni-shikararetai"} className="cursor-pointer">
