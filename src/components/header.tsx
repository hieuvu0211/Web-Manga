        ...
        <>
            <div className="hed flex mx-auto items-center">
                ...
                <div className="flex head_middle items-center ml-52">
                    ...
                    <div className="flex head_light_mes ml-7">
                        <div className="mr-3.5 head_light cursor-pointer">
                        ...
                        <div className="head_mes cursor-pointer">
                            ...
                            <ul className="options">
                                <li>Unknow: Đã trả lời bình luận của bạn về truyện Grand Blue</li>
                                <li>Unknow2: Đã trả lời bình luận của bạn về truyện Frieren no sounen</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="hover-container">
                    <button
                        className="bg-gray-800 hover:bg-gray-700 text-white font-bold py-1 px-3 border border-gray-700 hover:border-transparent rounded">
                        hi,guest
                    </button>
            ...
            <div className="navbar flex mx-auto px-44 items-center justify-around bg-gray-200">
                <div className="navbar_item navbar_home flex items-center justify-center">
                    <svg onClick={() => router.push('/')} xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 576 512">
                        <path
