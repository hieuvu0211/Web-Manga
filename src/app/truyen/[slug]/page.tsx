    ...
    return (
        <>
            <div className="manga_container">
                <div className="manga_title text-2xl">Trang chủ {">"} Kuro No Shoukanshi</div>
                <div className="manga_content mt-2">
                    <div className="manga_image">
                        <Image src={`/images/manga/${data}.jpg`} alt={""}
                            width={250}
                            height={250}
                            className="image" />
                    </div>
                    <div className="manga_describe">
                        <div className="font-bold text-xl">Kuro No Shoukanshi</div>
                        <div className="manga_list_title">
                            ...
                            <div className="font-bold flex items-center">Kuro No Shoukanshi</div>
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                                    <path
                ...
                <div className="manga_option flex">
                    <button className="bg-gray-300 hover:bg-green-500 flex items-center justify-center"
                        onClick={() => router.push(`/truyen/${data}/chap-1`)}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                            <path
                    ...
                    <button className=" bg-gray-300 hover:bg-red-500 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                            <path
                                d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z" />
                        </svg>
                ...
                <div className=" manga_introduce mt-2 mr-5 ml-5 ">
                    ...
                    <div className="manga_introduce_content">
                        Một thiếu niên có ngoại hiệu vua ngủ phế vật, trong họa được phúc mở ra một môn công pháp
                        nghịch thiên. Từ nay về sau, một cái nhục thể vô song kỳ tài, hoành áp thiên địa, kiếm trảm tinh
                        thần, ngàn vạn kỳ tài tại dưới chân hắn phủ phục run rẩy.
                    </div>
                </div>
                <Chapter />
                <Comment />
